...
void myBox(GLdouble x, GLdouble y, GLdouble z)
{
    ...
    glPushMatrix();
      glPushAttrib(GL_ALL_ATTRIB_BITS); // Save current state
...
void draw_crankbell(void)
{
    ...
    glTranslatef(0.0, 0.2, 0.12);
    myCylinder(obj, 0.06, 0.0, 0.28);
...
/* Makes a simple check pattern image.  */
